package Box2D.Collision
{
   ...
   public class b2DynamicTreeBroadPhase implements IBroadPhase
   {
      ...
      {
         var _loc3_:b2DynamicTreeNode = m_tree.CreateProxy(param1,param2);
      ...
      {
         var _loc4_:b2AABB = m_tree.GetFatAABB(param1);
         var _loc3_:b2AABB = m_tree.GetFatAABB(param2);
         return _loc4_.TestOverlap(_loc3_);
      }
