package Box2D.Dynamics.Joints
{
   ...
   public class b2PulleyJointDef extends b2JointDef
   {
      ...
      public function Initialize(param1:b2Body, param2:b2Body, param3:b2Vec2, param4:b2Vec2, param5:b2Vec2, param6:b2Vec2, param7:Number) : void
      {
         ...
         var _loc11_:Number = param5.y - param3.y;
         lengthA = Math.sqrt(_loc12_ * _loc12_ + _loc11_ * _loc11_);
         var _loc10_:Number = param6.x - param4.x;
         var _loc9_:Number = param6.y - param4.y;
         lengthB = Math.sqrt(_loc10_ * _loc10_ + _loc9_ * _loc9_);
         ratio = param7;
