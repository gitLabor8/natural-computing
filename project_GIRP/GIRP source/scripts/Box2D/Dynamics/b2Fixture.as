package Box2D.Dynamics
{
   ...
   public class b2Fixture
   {
      ...
      b2internal function Synchronize(param1:IBroadPhase, param2:b2Transform, param3:b2Transform) : void
      {
         ...
         m_shape.ComputeAABB(_loc6_,param3);
         m_aabb.Combine(_loc4_,_loc6_);
         var _loc5_:b2Vec2 = b2Math.SubtractVV(param3.position,param2.position);
         param1.MoveProxy(m_proxy,m_aabb,_loc5_);
      }
   }
}
