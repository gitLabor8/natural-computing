package Box2D.Dynamics
{
   ...
   public class b2Body
   {
      ...
      private function connectEdges(param1:b2EdgeShape, param2:b2EdgeShape, param3:Number) : Number
      {
         ...
         var _loc6_:Number = Math.tan((_loc4_ - param3) * 0.5);
         ...
         var _loc8_:b2Vec2 = b2Math.AddVV(param1.GetDirectionVector(),param2.GetDirectionVector());
         _loc8_.Normalize();
         var _loc7_:* = b2Math.Dot(param1.GetDirectionVector(),param2.GetNormalVector()) > 0;
         param1.SetNextEdge(param2,_loc5_,_loc8_,_loc7_);
         param2.SetPrevEdge(param1,_loc5_,_loc8_,_loc7_);
         return _loc4_;
      }
      ...
      public function DestroyFixture(param1:b2Fixture) : void
      {
         ...
         var _loc2_:b2Fixture = m_fixtureList;
         var _loc6_:* = null;
         ...
         while(_loc3_)
         {
            ...
            {
               m_world.m_contactManager.Destroy(_loc4_);
            }
         }
         if(m_flags & e_activeFlag)
         {
            _loc5_ = m_world.m_contactManager.m_broadPhase;
            param1.DestroyProxy(_loc5_);
         }
         param1.Destroy();
         param1.m_body = null;
         param1.m_next = null;
      ...
      public function SetPositionAndAngle(param1:b2Vec2, param2:Number) : void
      {
         ...
         m_sweep.c.x = _loc4_.col1.x * _loc6_.x + _loc4_.col2.x * _loc6_.y;
         m_sweep.c.y = _loc4_.col1.y * _loc6_.x + _loc4_.col2.y * _loc6_.y;
         m_sweep.c.x = m_sweep.c.x + m_xf.position.x;
         m_sweep.c.y = m_sweep.c.y + m_xf.position.y;
         m_sweep.c0.SetV(m_sweep.c);
         var _loc7_:* = param2;
         ...
         while(_loc3_)
         {
            _loc3_.Synchronize(_loc5_,m_xf,m_xf);
      ...
      public function Split(param1:Function) : b2Body
      {
         ...
         var _loc2_:* = null;
         var _loc7_:* = null;
         var _loc5_:b2Vec2 = GetLinearVelocity().Copy();
         var _loc13_:Number = GetAngularVelocity();
         var _loc11_:b2Vec2 = GetWorldCenter();
         var _loc9_:* = this;
         var _loc12_:b2Body = m_world.CreateBody(GetDefinition());
         _loc2_ = _loc9_.m_fixtureList;
         while(_loc2_)
         {
            if(param1(_loc2_))
            {
               _loc7_ = _loc2_.m_next;
               if(_loc10_)
               {
                  _loc10_.m_next = _loc7_;
               }
               else
               {
                  _loc9_.m_fixtureList = _loc7_;
               }
               _loc9_.m_fixtureCount = Number(_loc9_.m_fixtureCount) - 1;
               _loc2_.m_next = _loc12_.m_fixtureList;
               _loc12_.m_fixtureList = _loc2_;
               _loc12_.m_fixtureCount = Number(_loc12_.m_fixtureCount) + 1;
               _loc2_.m_body = _loc12_;
               _loc2_ = _loc7_;
            }
            else
            {
         ...
         _loc9_.ResetMassData();
         _loc12_.ResetMassData();
         var _loc8_:b2Vec2 = _loc9_.GetWorldCenter();
         var _loc6_:b2Vec2 = _loc12_.GetWorldCenter();
         var _loc3_:b2Vec2 = b2Math.AddVV(_loc5_,b2Math.CrossFV(_loc13_,b2Math.SubtractVV(_loc8_,_loc11_)));
         var _loc4_:b2Vec2 = b2Math.AddVV(_loc5_,b2Math.CrossFV(_loc13_,b2Math.SubtractVV(_loc6_,_loc11_)));
         _loc9_.SetLinearVelocity(_loc3_);
         _loc12_.SetLinearVelocity(_loc4_);
         _loc9_.SetAngularVelocity(_loc13_);
         _loc12_.SetAngularVelocity(_loc13_);
         _loc9_.SynchronizeFixtures();
         _loc12_.SynchronizeFixtures();
         return _loc12_;
      }
      ...
      public function Merge(param1:b2Body) : void
      {
         ...
         var _loc11_:* = null;
         var _loc2_:* = null;
         _loc3_ = param1.m_fixtureList;
         while(_loc3_)
         {
            _loc8_ = _loc3_.m_next;
            param1.m_fixtureCount--;
            _loc3_.m_next = m_fixtureList;
            m_fixtureList = _loc3_;
            m_fixtureCount = Number(m_fixtureCount) + 1;
            _loc3_.m_body = _loc2_;
            _loc3_ = _loc8_;
         }
         _loc11_.m_fixtureCount = 0;
         _loc11_ = this;
         _loc2_ = param1;
         var _loc7_:b2Vec2 = _loc11_.GetWorldCenter();
         var _loc6_:b2Vec2 = _loc2_.GetWorldCenter();
         var _loc4_:b2Vec2 = _loc11_.GetLinearVelocity().Copy();
         var _loc5_:b2Vec2 = _loc2_.GetLinearVelocity().Copy();
         var _loc10_:Number = _loc11_.GetAngularVelocity();
         var _loc9_:Number = _loc2_.GetAngularVelocity();
         _loc11_.ResetMassData();
         SynchronizeFixtures();
      }
      ...
      public function ResetMassData() : void
      {
         ...
         {
            m_I = m_I - m_mass * (_loc3_.x * _loc3_.x + _loc3_.y * _loc3_.y);
      ...
      {
         var _loc3_:b2Mat22 = m_xf.R;
         var _loc2_:b2Vec2 = new b2Vec2(_loc3_.col1.x * param1.x + _loc3_.col2.x * param1.y,_loc3_.col1.y * param1.x + _loc3_.col2.y * param1.y);
         _loc2_.x = _loc2_.x + m_xf.position.x;
         _loc2_.y = _loc2_.y + m_xf.position.y;
         return _loc2_;
      }
      ...
      public function SetActive(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            while(_loc2_)
            {
               _loc2_.CreateProxy(_loc5_,m_xf);
               _loc2_ = _loc2_.m_next;
            }
         }
         else
         {
            ...
            while(_loc4_)
            {
               _loc3_ = _loc4_;
               _loc4_ = _loc4_.next;
               m_world.m_contactManager.Destroy(_loc3_.contact);
            }
            m_contactList = null;
         }
      }
      ...
      {
         var _loc1_:* = null;
         var _loc2_:b2Transform = s_xf1;
         _loc2_.R.Set(m_sweep.a0);
         var _loc3_:b2Mat22 = _loc2_.R;
         var _loc5_:b2Vec2 = m_sweep.localCenter;
         _loc2_.position.x = m_sweep.c0.x - (_loc3_.col1.x * _loc5_.x + _loc3_.col2.x * _loc5_.y);
         _loc2_.position.y = m_sweep.c0.y - (_loc3_.col1.y * _loc5_.x + _loc3_.col2.y * _loc5_.y);
         var _loc4_:IBroadPhase = m_world.m_contactManager.m_broadPhase;
         _loc1_ = m_fixtureList;
         while(_loc1_)
         {
            _loc1_.Synchronize(_loc4_,_loc2_,m_xf);
