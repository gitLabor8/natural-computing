package Box2D.Common.Math
{
   public class b2Sweep
   {
      ...
      public function GetTransform(param1:b2Transform, param2:Number) : void
      {
         ...
         var _loc4_:Number = (1 - param2) * a0 + param2 * a;
         param1.R.Set(_loc4_);
         var _loc3_:b2Mat22 = param1.R;
         param1.position.x = param1.position.x - (_loc3_.col1.x * localCenter.x + _loc3_.col2.x * localCenter.y);
         param1.position.y = param1.position.y - (_loc3_.col1.y * localCenter.x + _loc3_.col2.y * localCenter.y);
      }
