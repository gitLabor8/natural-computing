package Box2D.Common.Math
{
   public class b2Math
   {
      ...
      {
         var _loc3_:b2Vec2 = new b2Vec2(param2 * param1.y,-param2 * param1.x);
         return _loc3_;
      }
      
      public static function CrossFV(param1:Number, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = new b2Vec2(-param1 * param2.y,param1 * param2.x);
         return _loc3_;
      }
      
      public static function MulMV(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = new b2Vec2(param1.col1.x * param2.x + param1.col2.x * param2.y,param1.col1.y * param2.x + param1.col2.y * param2.y);
         return _loc3_;
      }
      
      public static function MulTMV(param1:b2Mat22, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = new b2Vec2(Dot(param2,param1.col1),Dot(param2,param1.col2));
         return _loc3_;
      }
      
      public static function MulX(param1:b2Transform, param2:b2Vec2) : b2Vec2
      {
         var _loc3_:b2Vec2 = MulMV(param1.R,param2);
      ...
      {
         var _loc3_:b2Vec2 = SubtractVV(param2,param1.position);
      ...
      {
         var _loc3_:b2Vec2 = new b2Vec2(param1.x + param2.x,param1.y + param2.y);
         return _loc3_;
      }
      ...
      {
         var _loc3_:b2Vec2 = new b2Vec2(param1 * param2.x,param1 * param2.y);
         return _loc3_;
      }
      
      public static function AddMM(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Mat22 = b2Mat22.FromVV(AddVV(param1.col1,param2.col1),AddVV(param1.col2,param2.col2));
         return _loc3_;
      }
      
      public static function MulMM(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         var _loc3_:b2Mat22 = b2Mat22.FromVV(MulMV(param1,param2.col1),MulMV(param1,param2.col2));
         return _loc3_;
      }
      ...
      public static function MulTMM(param1:b2Mat22, param2:b2Mat22) : b2Mat22
      {
         ...
         var _loc5_:b2Mat22 = b2Mat22.FromVV(_loc3_,_loc4_);
         return _loc5_;
      }
      ...
      {
         var _loc2_:b2Vec2 = new b2Vec2(Abs(param1.x),Abs(param1.y));
         return _loc2_;
      }
      
      public static function AbsM(param1:b2Mat22) : b2Mat22
      {
         var _loc2_:b2Mat22 = b2Mat22.FromVV(AbsV(param1.col1),AbsV(param1.col2));
         return _loc2_;
      }
      ...
      {
         var _loc3_:b2Vec2 = new b2Vec2(Min(param1.x,param2.x),Min(param1.y,param2.y));
         return _loc3_;
      }
      ...
      {
         var _loc3_:b2Vec2 = new b2Vec2(Max(param1.x,param2.x),Max(param1.y,param2.y));
         return _loc3_;
      }
